...
def block2D(numX, numY, startNode, startEle, eleType, eleArgs, crds):
    ...
    Hint:
        unchecked
    """
    ops.block3D(numX, numY, startNode, startEle, eleType, *eleArgs, *crds)





def block3D(numX, numY, numZ, startNode, startEle, eleType, eleArgs, crds):
    """
    Create mesh of quadrilateral elements
    ...
    Hint:
        unchecked
    """
    ops.block3D(numX, numY, numZ, startNode, startEle, eleType, *eleArgs, *crds)
