...
.. note::
   ...
   If strain-hardening ratio is zero and you do not expect softening of your system use BandSPD solver.
    ...
    """
    uniqueArgs = []
    ops.uniaxialMaterial('Steel01', matTag, Fy, E0, b, a1, a2, a3, a4, *uniqueArgs)

def Steel02(matTag, Fy, E0, b, params, a1, a2, a3, a4, sigInit):
    """
...
.. seealso::
   ...
   `Steel02 <http://opensees.berkeley.edu/wiki/index.php/Steel02_Material_--_Giuffr%C3%A9-Menegotto-Pinto_Model_with_Isotropic_Strain_Hardening>`_
    ...
    """
    uniqueArgs = []
    ops.uniaxialMaterial('Steel02', matTag, Fy, E0, b, *params, a1, a2, a3, a4, sigInit, *uniqueArgs)

def Steel4(matTag, Fy, E0, b_k=None, params=None, b_kc=None, R_0c=None, r_1c=None, r_2c=None, b_i=None, rho_i=None, b_l=None, R_i=None, l_yp=None, b_ic=None, rho_ic=None, b_lc=None, R_ic=None, f_u=None, R_u=None, f_uc=None, R_uc=None, sig_init=None, cycNum=None):
    """
...
.. seealso::
   ...
   `Hysteretic <http://opensees.berkeley.edu/wiki/index.php/Hysteretic_Material>`_
    ...
    """
    uniqueArgs = []
    ops.uniaxialMaterial('Hysteretic', matTag, *p1, *p2, *p3, *n1, *n2, *n3, pinchX, pinchY, damage1, damage2, beta, *uniqueArgs)
...
.. seealso::
   ...
   `Notes <http://opensees.berkeley.edu/wiki/index.php/SteelMPF_-_Menegotto_and_Pinto_(1973)_Model_Extended_by_Filippou_et_al._(1983)>`_
    ...
    """
    uniqueArgs = []
    ops.uniaxialMaterial('SteelMPF', matTag, fyp, fyn, E0, bp, bn, *params, a1, a2, a3, a4, *uniqueArgs)
