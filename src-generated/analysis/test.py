...
def NormUnbalance(tol, iter, pFlag, nType, maxIncr):
    """
   ...
   When using the Penalty method additional large forces to enforce the penalty functions exist on the right hand side, making convergence using this test usually impossible (even though solution might have converged).
    ...
    """
    uniqueArgs = []
    ops.test('NormUnbalance', tol, iter, pFlag, nType, maxIncr, *uniqueArgs)

def NormDispIncr(tol, iter, pFlag, nType):
    """
   ...
   When using the Lagrange method to enforce the constraints, the Lagrange multipliers appear in the solution vector.
    ...
    """
    uniqueArgs = []
    ops.test('NormDispIncr', tol, iter, pFlag, nType, *uniqueArgs)

def EnergyIncr(tol, iter, pFlag, nType):
    """
   ...
   * When using the Lagrange method to enforce the constraints, the Lagrange multipliers appear in the solution vector.
    ...
    """
    uniqueArgs = []
    ops.test('EnergyIncr', tol, iter, pFlag, nType, *uniqueArgs)

def RelativeNormUnbalance(tol, iter, pFlag, nType):
    """
   ...
   * When using the Penalty method additional large forces to enforce the penalty functions exist on the right hand side, making convergence using this test usually impossible (even though solution might have converged).
    ...
    """
    uniqueArgs = []
    ops.test('RelativeNormUnbalance', tol, iter, pFlag, nType, *uniqueArgs)

def RelativeNormDispIncr(tol, iter, pFlag, nType):
    """
   ...
   ======================   =============================================================
    ...
    """
    uniqueArgs = []
    ops.test('RelativeNormDispIncr', tol, iter, pFlag, nType, *uniqueArgs)

def RelativeTotalNormDispIncr(tol, iter, pFlag, nType):
    """
   ...
   ======================   =============================================================
    ...
    """
    uniqueArgs = []
    ops.test('RelativeTotalNormDispIncr', tol, iter, pFlag, nType, *uniqueArgs)

def RelativeEnergyIncr(tol, iter, pFlag, nType):
    """
...
def FixedNumIter(iter, pFlag, nType):
    """
   ...
   ======================   =============================================================
    ...
    """
    uniqueArgs = []
    ops.test('FixedNumIter', iter, pFlag, nType, *uniqueArgs)

def NormDispAndUnbalance(tolIncr, tolR, iter, pFlag, nType, maxincr):
    """
   ...
   ======================   =============================================================
    ...
    """
    uniqueArgs = []
    ops.test('NormDispAndUnbalance', tolIncr, tolR, iter, pFlag, nType, maxincr, *uniqueArgs)

def NormDispOrUnbalance(tolIncr, tolR, iter, pFlag, nType, maxincr):
    """
   ...
   ======================   =============================================================
    ...
    """
    uniqueArgs = []
    ops.test('NormDispOrUnbalance', tolIncr, tolR, iter, pFlag, nType, maxincr, *uniqueArgs)
