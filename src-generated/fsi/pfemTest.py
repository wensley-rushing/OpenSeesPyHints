...
def PFEM(tolv, tolp, tolrv, tolrp, tolrelv, tolrelp, iter, maxincr, pFlag, nType):
    """
   ...
   ======================   =========================================================================
    ...
    """
    uniqueArgs = []
    ops.test('PFEM', tolv, tolp, tolrv, tolrp, tolrelv, tolrelp, iter, maxincr, pFlag, nType, *uniqueArgs)
